 ...
 *
 * @package LEAStudios\Forms\Encryption
 */

declare(strict_types=1);

namespace LEAStudios\Forms\Encryption;
...
class Options_Encryptor {
	...
	private function derive_key(): string {
		if ( ! defined( 'AUTH_KEY' ) || ! defined( 'SECURE_AUTH_SALT' ) ) {
			wp_die(
				esc_html__( 'leastudios Forms requires AUTH_KEY and SECURE_AUTH_SALT to be defined in wp-config.php for encryption to work.', 'leastudios-forms' )
			);
		}
